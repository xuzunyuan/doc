...
CREATE TABLE `t_brand` (
  ...
  `brand_ename` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `logo_url` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `brand_abbr` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `brand_story` varchar(2000) COLLATE utf8_bin DEFAULT NULL,
  `create_date` datetime DEFAULT NULL,
  `status` char(1) COLLATE utf8_bin DEFAULT NULL COMMENT '0正常，1删除\n            ',
  `create_by_name` varchar(30) COLLATE utf8_bin DEFAULT NULL COMMENT '系统创建',
