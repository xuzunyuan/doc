...
--
-- Table structure for table `t_seller_apply`
--

DROP TABLE IF EXISTS `t_seller_apply`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_seller_apply` (
  `app_id` int(11) NOT NULL AUTO_INCREMENT,
  `seller_login_id` int(11) NOT NULL,
  `apply_type` char(1) COLLATE utf8_bin DEFAULT 'c' COMMENT 'c -个人;b-商家\n            ',
  `apply_date` datetime DEFAULT NULL,
  `apply_ip` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `status` char(1) COLLATE utf8_bin DEFAULT '1' COMMENT '1-待审核；2-通过；3-驳回',
...
--
-- Dumping data for table `t_seller_apply`
--

LOCK TABLES `t_seller_apply` WRITE;
/*!40000 ALTER TABLE `t_seller_apply` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_seller_apply` ENABLE KEYS */;
UNLOCK TABLES;
